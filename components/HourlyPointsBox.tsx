...
export default function HourlyPointsBox({ data, timezone }: Props) {
  ...
  const hourlyData = useMemo(() => {
    ...
    filtered.forEach((d) => {
      ...
      grouped[hourStr]?.push(d.Points_Pool);
    });
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={hourlyData}>
            ...
            <Bar dataKey="avgPoints" fill="#f783ac" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
